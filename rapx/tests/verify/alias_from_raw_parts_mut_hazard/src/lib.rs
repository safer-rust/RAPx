...
#[rapx::requires(ValidPtr(ptr, u8, mem::size_of::<u16>()))]
#[rapx::requires(Init(ptr, u8, mem::size_of::<u16>()))]
...
#[rapx::verify]
#[rapx::requires(NonNull(ptr))]
#[rapx::requires(ValidPtr(ptr, u8, len * mem::size_of::<u16>()))]
#[rapx::requires(Init(ptr, u8, len * mem::size_of::<u16>()))]
#[rapx::requires(Alive(ptr, 'a))]
